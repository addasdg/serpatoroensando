...
if not syn and not PROTOSMASHER_LOADED then print'Ryans ESP only officially supports Synapse and Protosmasher! If you\'re an exploit developer and have added drawing API to your exploit, try setting syn as true then checking if that works, otherwise' end
...
shared.RSName = shared.RSName or ('RyansESP_by_ic3-' .. HttpService:GenerateGUID(false))
